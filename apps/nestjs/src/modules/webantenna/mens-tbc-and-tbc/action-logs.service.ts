...
@Injectable()
export class WebantennaActionLogService implements LogService {
  private readonly SELECTORS = {
    ...
    REPORT: {
      CV_TAB: "#id-tab-cvreport",
      TODAY: "#id-term-today",
      DOWNLOAD: "#id-cvreport-download-button",
    },
  };

  constructor(
    private readonly repository: WebantennaActionLogRepository,
  ...
  async fetchAndInsertLogs(): Promise<number> {
    ...
    try {
      ...
      // レポート画面の操作
      await (await page.waitForSelector(this.SELECTORS.REPORT.CV_TAB)).click();
