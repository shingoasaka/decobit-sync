...
import { CatsActionLogRepository } from "./action-logs.repository";
...
@Injectable()
export class CatsActionLogService implements LogService {
  constructor(
    private readonly repository: CatsActionLogRepository,
